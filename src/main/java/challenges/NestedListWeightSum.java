...
/**
 * ou are given a nested list of integers nestedList. Each element is either an integer or a list
    ...
    private int dfsSum (List<NestedInteger> nestedList, int depth)
    {
        ...
        for (NestedInteger ni : nestedList) {
            if (ni.isInteger()) {
                ...
                total = total + dfsSum(ni.getList(), depth + 1);
            }
        }
    ...
    public int depthSumBFS (List<NestedInteger> nestedList)
    {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (ni.isInteger()) {
                    total = total + depth * ni.getInteger();
                }
                else {
